                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="d-flex align-items-center">
                                <img class="rounded-circle header-profile-user" src="<?php echo base_url()?>assets/images/users/user-dummy-img.jpg" alt="Header Avatar">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <h6 class="dropdown-header">Welcome <?php echo $userdata['complete_name'] ?>!</h6>
                            ...
                            <a class="dropdown-item" href="<?php echo site_url('log/logout') ?>" onclick="return confirm('Apakah Anda yakin ingin keluar dari aplikasi?');"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                        </div>
                    </div>
                </div>
            </div>
