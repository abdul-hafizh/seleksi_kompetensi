    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header border-bottom pb-2">
                ...
                <div class="float-end">
                    <a href="<?php echo site_url('serah_terima_barang/add');?>" class="btn btn-primary btn-sm"><i class="ri-add-line align-middle me-1"></i> Tambah Serah Terima Barang</a>
                </div>
            </div>
...
<script>    
    $(document).ready(function () {
        var table = $("#data-form").DataTable({             
            ...
            'serverMethod': 'POST',
            'ajax': {
                'url':'<?php echo site_url('serah_terima_barang/get_data');?>',
                "type": "POST",
                "data": function(d){                    
