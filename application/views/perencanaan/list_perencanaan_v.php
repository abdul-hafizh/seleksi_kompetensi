        ...
        <div class="card">
            <div class="card-header border-bottom pb-2">
                <div class="float-start">
                    <h5 class="card-title mb-0">Data Perencanaan</h5>
                </div>
                <div class="float-end">
                    <a href="<?php echo site_url('perencanaan/add');?>" class="btn btn-primary btn-sm"><i class="ri-add-line align-middle me-1"></i> Tambah Perencanaan</a>
                </div>
            </div>
...
<script>    
    $(document).ready(function () {
        var table = $("#data-form").DataTable({             
            ...
            'serverMethod': 'POST',
            'ajax': {
                'url':'<?php echo site_url('perencanaan/get_data');?>',
                "type": "POST",
                "data": function(d){                    
