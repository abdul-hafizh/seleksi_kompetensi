        ...
        <div class="card">
            <div class="card-header border-bottom pb-2">
                <div class="float-start">
                    <h5 class="card-title mb-0">Data Lokasi SKD</h5>
                </div>
                <div class="float-end">
                    <a href="<?php echo site_url('manajemen_data/lokasi_skd/add');?>" class="btn btn-primary btn-sm"><i class="ri-add-line align-middle me-1"></i> Tambah Lokasi SKD</a>
                </div>
            </div>
