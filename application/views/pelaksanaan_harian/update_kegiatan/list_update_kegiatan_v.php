        ...
        <div class="card">
            <div class="card-header border-bottom pb-2">
                <div class="float-start">
                    <h5 class="card-title mb-0">Data Update Kegiatan</h5>
                </div>
                <div class="float-end">
                    <a href="<?php echo site_url('pelaksanaan_harian/update_kegiatan/add');?>" class="btn btn-primary btn-sm"><i class="ri-add-line align-middle me-1"></i> Tambah Update Kegiatan</a>
                </div>
            </div>
...
<script>    
    $(document).ready(function () {
        var table = $("#data-form").DataTable({             
            ...
            'serverMethod': 'POST',
            'ajax': {
                'url':'<?php echo site_url('pelaksanaan_harian/update_kegiatan/get_data');?>',
                "type": "POST",
                "data": function(d){                    
